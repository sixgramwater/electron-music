...
const AlbumDetailPage: React.FC = () => {
  ...
  const curPlaylistIndex = useAppSelector((state) =>
    state.music.playlists.findIndex((list) => list.id === id)
  );
  const curPlaylist = useAppSelector((state) =>
    curPlaylistIndex !== -1
      ? state.music.playlists[curPlaylistIndex]
      : undefined
  );
      ...
      <div className={styles.albumDetailPage}>
        <div className={styles.detailHeader}>
          <div className={styles.albumCover}>
            <img
              src={curPlaylist ? curPlaylist.picUrl : albumCover}
              alt="cover"
            />
          </div>
            ...
            <div className={styles.detailDesc}>
              <div className={styles.author}>
                <div className={styles.albumAvatar}>
                  <img
                    src={curPlaylist ? curPlaylist.creator.avatarUrl : ''}
                    alt="avatar"
                  />
                  {/* <img src="" alt="avatar" /> */}
                </div>
                <span>
                  {curPlaylist ? curPlaylist.creator.nickname : 'creator'}
                </span>
              </div>
